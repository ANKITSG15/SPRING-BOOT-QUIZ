...
public class DataAccessServiceTest {
    ...
    private final GlobalUtility globalUtility = Mockito.mock(GlobalUtility.class);
    ...
    @Before
    public void setup(){
        dataAccessService = new DataAccessService(config, quizRepository, userRepository, globalUtility, studentRepository);
    ...
    public void getCorrectAnsTest() {
        when(quizRepository.findAll()).thenReturn(Stream.of
